...
/**
 * The common exception for all reflection operations which can be thrown for
 * example from helper static class {@link ReflectionUtils}.
 *
 * @author Mr.FrAnTA
 * @since 1.0
 */
public class ReflectionException extends JopException {
  ...
  /**
   * Constructs a new reflection exception with <code>null</code> as its detail
  ...
  /**
   * Constructs a new reflection exception with the specified cause and
  ...
  /**
   * Constructs a new reflection exception with the specified detail message and
   * cause.
   * <p>
