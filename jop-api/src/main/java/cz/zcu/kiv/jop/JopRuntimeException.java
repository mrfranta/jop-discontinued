...
/**
 * Common runtime exception for all runtime exceptions in this library which provides the common
 * behavior for all of them and also brings possibility to catching exceptions in one simple catch
 * block. Also it brings possibility to more flow of exception through multiple method calls.
 *
 * @author Mr.FrAnTA
 * @since 1.0.0
 */
public class JopRuntimeException extends RuntimeException {
  ...
  /**
   * Constructs a new runtime exception with the specified cause and <code>null</code> as its detail
  ...
  /**
   * Returns the detail message string of this runtime exception. If message is <code>null</code>
   * (because of complex constructors) and there is no default message ({@link #getDefaultMessage}),
   * the message from cause will be returned.
   *
   * @return The detail message string of this {@link JopRuntimeException} instance.
   */
  @Override
