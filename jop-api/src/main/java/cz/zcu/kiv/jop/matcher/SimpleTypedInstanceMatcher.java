...
/**
 * Abstract implementation of {@link TypedInstanceMatcher} interface which don't need parameters for
 ...
 */
public abstract class SimpleTypedInstanceMatcher<T> implements TypedInstanceMatcher<T, EmptyParameters> {
   ...
   */
  public final boolean matches(T obj, EmptyParameters params) {
    return matches(obj);
  }
