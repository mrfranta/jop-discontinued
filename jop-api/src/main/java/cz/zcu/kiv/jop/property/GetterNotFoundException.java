...
/**
 * This exception may occur in case that no <em>getter</em> for the property was not found.
 *
 * @author Mr.FrAnTA
 * @since 1.0.0
 */
public class GetterNotFoundException extends PropertyException {
  ...
  /**
   * Constructs a new exception for not found getter with <code>null</code> as its detail message.
  ...
  /**
   * Constructs a new exception for not found getter with the specified detail message. The cause is
  ...
  /**
   * Constructs a new exception for not found getter with the specified cause and <code>null</code>
  ...
  /**
   * Constructs a new exception for not found getter with the specified detail message and cause.
   * <p>
  ...
  protected String getDefaultMessage() {
    return "Could not find a getter for " + getPropertyName() + " in class " + getDeclaringClassName();
  }
