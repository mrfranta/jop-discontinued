...
public interface Bean extends AnnotatedElement {
  ...
  /**
   * Returns bean for parent class of class type of this bean. It may return <code>null</code> value
   * if class type of this bean has no parent or if parent is {@link Object}.
   *
  ...
  /**
   * Returns declared property of this bean with given name. If this bean doesn't contain property
   * with given name, the <code>null</code> value will be returned.
   *
