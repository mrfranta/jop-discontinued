...
/**
 * Runtime exception which can be thrown if some error occurs during evaluation
 * of expression(s) in {@link Evaluator}. It's recommended to not throw another
 * exceptions from methods of {@link Evaluator}.
 *
 * @author Mr.FrAnTA
 * @since 1.0
 */
public class EvaluatorException extends JopRuntimeException {
  ...
  /**
   * Constructs a new evaluator exception with <code>null</code> as its detail
  ...
  /**
   * Constructs a new evaluator exception with the specified detail message. The
  ...
  /**
   * Constructs a new evaluator exception with the specified cause and
  ...
  /**
   * Constructs a new evaluator exception with the specified detail message and
   * cause.
   * <p>
