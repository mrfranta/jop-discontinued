...
/**
 * The common interface for all matchers of objects (instances). This interface has type parameter
 * for type of accepted type of checked objects.
 * <p>
 ...
 * <p>
 * Second type parameter is for annotation type of instance matcher parameters. The parameters for
 * {@link #matches} method are always stored in annotation (for example: by which is annotated the
 * field for which will be searched wanted instance).
 *
 * @author Mr.FrAnTA
 * @since 1.0.0
 *
