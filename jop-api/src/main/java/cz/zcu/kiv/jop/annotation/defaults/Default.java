 ...
 * declared as <code>Class<?></code>. The class is abstract and has private constructor - it's
 * "static" - so cannot be extended or it cannot be created new instance of it.
 *
 * @author Mr.FrAnTA
 * @since 1.0.0
 */
