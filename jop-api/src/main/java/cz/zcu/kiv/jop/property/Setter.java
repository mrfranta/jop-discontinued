...
/**
 * This interface extends {@code PropertyAccess} interface for setting of property value.
 *
 * @author Mr.FrAnTA
 * @since 1.0.0
 *
...
public interface Setter<T> extends PropertyAccess<T> {
   ...
   * @throws PropertyAccessException If some problem occurs during setting of the value to property.
   */
