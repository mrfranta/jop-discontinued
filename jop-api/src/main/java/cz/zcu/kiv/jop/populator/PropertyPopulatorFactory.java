...
public interface PropertyPopulatorFactory extends BindingFactory<TypedPropertyPopulator<?, ?>> {
   ...
   * <p>
   * In case that there is no bound implementation of class property populator for given annotation
   * the exception may be thrown - the <code>null</code> value should not be returned.
   *
   * @param annotation the annotation for which will be created bound instance of property populator
   *          implementation.
   * @return Created instance of property populator implementation which was bound to given
   *         annotation.
