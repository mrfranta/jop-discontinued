...
/**
 * The general runtime exception which can occur during manipulation with <em>Object</em>'s
 * properties.
 *
 * @author Mr.FrAnTA
 * @since 1.0.0
...
public class PropertyRuntimeException extends JopRuntimeException {
  ...
  /**
   * Constructs a new property runtime exception with <code>null</code> as its detail message. The
   ...
   */
  public PropertyRuntimeException(Class<?> declaringClass, String propertyName) {
    this(null, null, declaringClass, propertyName);
  }

  /**
   * Constructs a new property runtime exception with the specified detail message. The cause is not
   ...
   * @param propertyName the name of property.
   */
  public PropertyRuntimeException(String message, Class<?> declaringClass, String propertyName) {
    this(message, null, declaringClass, propertyName);
  }

  /**
   * Constructs a new property runtime exception with the specified cause and <code>null</code> as
   ...
   * @param propertyName the name of property.
   */
  public PropertyRuntimeException(Throwable cause, Class<?> declaringClass, String propertyName) {
    this(null, cause, declaringClass, propertyName);
  }

  /**
   * Constructs a new property runtime exception with the specified detail message and cause.
   * <p>
   ...
   * @param propertyName the name of property.
   */
  public PropertyRuntimeException(String message, Throwable cause, Class<?> declaringClass, String propertyName) {
    super(message, cause);
