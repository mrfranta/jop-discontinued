 ...
 * value with <em>Poisson distribution</em> which is a discrete probability
 * distribution that expresses the probability of a given number of events
 * occurring in a fixed interval of time and/or space if these events occur with
 * a known average rate and independently of the time since the last event.
 * 
