...
/**
 * This exception may occur in case that some problem occurred during manipulation with property.
 *
 * @author Mr.FrAnTA
 * @since 1.0.0
 */
public class PropertyAccessException extends PropertyException {
  ...
  /**
   * Constructs a new property access exception with the specified detail message. The cause is not
  ...
  /**
   * Constructs a new property access exception with the specified detail message and cause.
   * <p>
  ...
  /**
   * Returns information whether the exception raised in {@link cz.zcu.kiv.jop.property.Setter
   * setter}.
   *
   * @return <code>true</code> if the exception raised in {@link cz.zcu.kiv.jop.property.Setter
   *         setter}; <code>false</code> if the exception raised in
   *         {@link cz.zcu.kiv.jop.property.Setter getter}.
   */
   ...
   *
   * @return The detail message string of this {@link PropertyAccessException} instance.
   */
  @Override
