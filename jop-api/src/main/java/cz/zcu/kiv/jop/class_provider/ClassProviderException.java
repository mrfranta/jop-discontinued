...
/**
 * Runtime exception which can be thrown if some error occurs during providing
 * of class which will be used for new instance. Also can be thrown in case of
 * value of some parameter is not valid. It's recommended to not throw another
 * exception from {@link ClassProvider#get provider method}.
 *
 * @author Mr.FrAnTA
 * @since 1.0
 */
public class ClassProviderException extends JopRuntimeException {
  ...
  /**
   * Constructs a new class provider exception with the specified detail
  ...
  /**
   * Constructs a new class provider exception with the specified cause and
  ...
  /**
   * Constructs a new class provider exception with the specified detail message
   * and cause.
   * <p>
