...
/**
 * Common interface for injector of dependencies (DI). An injector contains graph of objects that
 * make up structure of this library (or your program).
 * <p>
 * An injector {@link #getInstance(Class) provides assembled instances} of classes with all
 * dependencies.
 * <p>
...
public interface Injector {
   ...
   * <p>
   * Whenever an Injector creates an instance, it performs this method automatically (after first
   * performing constructor injection), so if it's possible let Injector create all objects.
   *
