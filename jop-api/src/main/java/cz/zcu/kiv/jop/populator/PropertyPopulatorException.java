...
/**
 * Runtime exception which can be thrown if some error occurs during populating
 * of property in {@link TypedPropertyPopulator#populate populate} method. Also
 * can be thrown in case of value of some parameter is not valid. It's
 * recommended to not throw another exception from mentioned method.
 *
 * @author Mr.FrAnTA
 * @since 1.0
 */
public class PropertyPopulatorException extends JopRuntimeException {
  ...
  /**
   * Constructs a new property populator exception with <code>null</code> as its
  ...
  /**
   * Constructs a new property populator exception with the specified detail
  ...
  /**
   * Constructs a new property populator exception with the specified cause and
