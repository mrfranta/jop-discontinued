...
/**
 * This exception can occur during binding in case of some error - for example
...
public class BindingException extends JopRuntimeException {
  ...
  /**
   * Constructs a new binding exception with <code>null</code> as its detail
  ...
  /**
   * Constructs a new binding exception with the specified detail message. The
  ...
  /**
   * Constructs a new binding exception with the specified cause and
