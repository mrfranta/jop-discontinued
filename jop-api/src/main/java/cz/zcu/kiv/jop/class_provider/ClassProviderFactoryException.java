 ...
 * {@link ClassProvider} creation in {@link ClassProviderFactory} - for example:
 * if no implementation of class provider was found for given annotation or if
 * entered annotation is not for class provider.
 *
 * @author Mr.FrAnTA
 * @since 1.0
 */
public class ClassProviderFactoryException extends JopException {
  ...
  /**
   * Constructs a new exeption for class provider factory with <code>null</code>
   * as its detail message. The cause is not initialized, and may subsequently
   * be initialized by a call to {@link #initCause}.
   */
  public ClassProviderFactoryException() {
    super();
  }

  /**
   * Constructs a new exeption for class provider factory with the specified
   ...
   */
  public ClassProviderFactoryException(String message) {
    super(message);
  }
   ...
   */
  public ClassProviderFactoryException(Throwable cause) {
    super(null, cause);
  }
   ...
   *          and indicates that the cause is nonexistent or unknown.)
   */
  public ClassProviderFactoryException(String message, Throwable cause) {
    super(message, cause);
  }
