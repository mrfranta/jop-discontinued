...
/**
 * Objects (instances) matcher annotation which determines the specific instance
 * of {@link TypedInstanceMatcher matcher} which decides which already generated
 * object (instance) can be set into populated field. Instance matcher cannot
