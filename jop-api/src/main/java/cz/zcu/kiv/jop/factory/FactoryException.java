...
/**
 * This exception can be thrown by {@link Factory} or their extensions if some error occurs during
 * creation of instance for implementation of interface <code>T</code>.
 *
 * @author Mr.FrAnTA
 * @since 1.0.0
 */
public class FactoryException extends JopException {
  ...
  /**
   * Constructs a new factory exception with <code>null</code> as its detail message. The cause is
  ...
  /**
   * Constructs a new factory exception with the specified detail message. The cause is not
  ...
  /**
   * Constructs a new factory exception with the specified cause and <code>null</code> as its detail
  ...
  /**
   * Constructs a new factory exception with the specified detail message and cause.
   * <p>
