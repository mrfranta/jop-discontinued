 ...
 * {@link TypedInstanceMatcher} creation in {@link InstanceMatcherFactory} - for
 * example: if no implementation of instance matcher was found for given
 * annotation or if entered annotation is not for instance matchers.
 *
 * @author Mr.FrAnTA
 * @since 1.0
 */
public class InstanceMatcherFactoryException extends JopException {
  ...
  /**
   * Constructs a new instance matcher factory exception with <code>null</code>
   * as its detail message. The cause is not initialized, and may subsequently
   * be initialized by a call to {@link #initCause}.
   */
  public InstanceMatcherFactoryException() {
    super();
  }

  /**
   * Constructs a new instance matcher factory exception with the specified
   ...
   */
  public InstanceMatcherFactoryException(String message) {
    super(message);
  }
   ...
   */
  public InstanceMatcherFactoryException(Throwable cause) {
    super(null, cause);
  }
   ...
   *          and indicates that the cause is nonexistent or unknown.)
   */
  public InstanceMatcherFactoryException(String message, Throwable cause) {
    super(message, cause);
  }
