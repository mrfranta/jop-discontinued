...
/**
 * Abstract implementation of {@link TypedClassProvider} interface which don't
 * need parameters for providing of classes. Also implementations of this class
 * can be used in
 ...
 */
public abstract class SimpleTypedClassProvider<T> implements TypedClassProvider<T, Empty> {
