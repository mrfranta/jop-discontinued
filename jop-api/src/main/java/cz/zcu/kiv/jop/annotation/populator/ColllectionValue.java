 ...
 * <p>
 * Notice: the final size of collection may be different than maximal or exact size of collection
...
public @interface ColllectionValue {
   ...
   * be lesser than or equals to {@link #max() maximum} and has to be greater than or equals to 0.
   * The default value is 0.
   */
  public int min() default 0;

  /**
   * Optional parameter for maximal size of populated collection property. Value of maximum has to
   * be greater than or equals to {@link #min() minimum} with one exception - if the value is lower
   ...
   * <p>
   * The final size may be different than maximal size of collection because a {@link java.util.Set
   ...
   * parameter is greater than or equals to 0, parameters for {@link #min() minimum} and
   * {@link #max() maximum} are ignored. The default value of this parameter is -1.
   * <p>
