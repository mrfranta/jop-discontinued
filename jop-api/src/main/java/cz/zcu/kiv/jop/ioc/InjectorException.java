...
/**
 * This runtime exception may be thrown if some error occurs while Injector
 * providing an instance or during injection of dependencies into some instance.
 *
 * @author Mr.FrAnTA
 * @since 1.0
 */
public class InjectorException extends JopRuntimeException {
  ...
  /**
   * Constructs a new Injector exception with <code>null</code> as its detail
  ...
  /**
   * Constructs a new Injector exception with the specified detail message. The
  ...
  /**
   * Constructs a new Injector exception with the specified cause and
  ...
  /**
   * Constructs a new Injector exception with the specified detail message and
   * cause.
   * <p>
