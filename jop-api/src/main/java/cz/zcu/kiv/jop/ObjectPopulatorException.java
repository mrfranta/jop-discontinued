...
/**
 * This exception can be thrown by methods of {@link ObjectPopulator} if some error occurs during
 * generating or populating of objects.
 *
 * @author Mr.FrAnTA
 * @since 1.0.0
 */
public class ObjectPopulatorException extends JopException {
   ...
   */
  public ObjectPopulatorException() {
    super();
  }
   ...
   */
  public ObjectPopulatorException(String message) {
    super(message);
  }
   ...
   *          unknown.)
   */
  public ObjectPopulatorException(Throwable cause) {
    super(null, cause);
  }
   ...
   *          unknown.)
   */
  public ObjectPopulatorException(String message, Throwable cause) {
    super(message, cause);
  }
